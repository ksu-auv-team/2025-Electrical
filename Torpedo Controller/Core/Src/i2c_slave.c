...
// ---- Simple register window ----
// R0: angle (0–180)
// R1: reserved
// R2..R3: pulse width (LSB,MSB)
...
static volatile uint8_t rx_count     = 0; // # of RX chunks
static volatile uint8_t rx_expected  = 0; // payload bytes after [reg][len]
